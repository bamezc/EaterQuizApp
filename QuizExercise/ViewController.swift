...
//  QuizExercise
//
//  Created by Amezcua, Bella G on 2/28/24.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func selectPizza(_ sender: Any) {
    ...
    @IBAction func selectTaco(_ sender: Any) {
        if (sender as AnyObject).isOn {
                    taco = 1
                }
               else {
    ...
    @IBAction func selectSushi(_ sender: Any) {
        if (sender as AnyObject).isOn {
                    sushi = 1
                }
               else {
